...
"""
    ...
    OpenAPI spec version: v2beta1.19 (recommended default)
...
class Identity(BaseService):
    ...
    def set_principal_public_keys(self, principal: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
        ...
        url = self.base_client.build_url(path)
        response = self.base_client.put(url, params=query_params)
        return handle_response(response, )

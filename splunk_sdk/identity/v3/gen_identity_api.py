...
from splunk_sdk.identity.v3.gen_models import CreateSamlClientBody
from splunk_sdk.identity.v3.gen_models import ECJwk
from splunk_sdk.identity.v3.gen_models import Entitlement
...
from splunk_sdk.identity.v3.gen_models import List
...
from splunk_sdk.identity.v3.gen_models import ResetPasswordBody
...
from splunk_sdk.identity.v3.gen_models import SamlClient
from splunk_sdk.identity.v3.gen_models import SetEntitlement
from splunk_sdk.identity.v3.gen_models import UpdateGroupBody
from splunk_sdk.identity.v3.gen_models import UpdatePasswordBody
from splunk_sdk.identity.v3.gen_models import UpdateRoleBody
from splunk_sdk.identity.v3.gen_models import UpdateSamlClientBody
...
class Identity(BaseService):
    ...
    def create_saml_client(self, create_saml_client_body: CreateSamlClientBody, query_params: Dict[str, object] = None) -> SamlClient:
        """
        ...
        path = Template("/identity/v3/clients/saml").substitute(path_params)
        url = self.base_client.build_url(path)
        data = create_saml_client_body.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, SamlClient)
    ...
    def delete_saml_client(self, saml_client: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
        ...
        path_params = {
            "samlClient": saml_client,
        }

        path = Template("/identity/v3/clients/saml/${samlClient}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.delete(url, params=query_params)
        return handle_response(response, )

    def get_entitlements(self, entitlement_client_id: str, query_params: Dict[str, object] = None) -> List[Entitlement]:
        """
        ...
        path_params = {
            "entitlementClientId": entitlement_client_id,
        }

        path = Template("/identity/v3/commerce/subscribed-apps/${entitlementClientId}/entitlements").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
        return handle_response(response, Entitlement)
    ...
    def get_saml_client(self, saml_client: str, query_params: Dict[str, object] = None) -> SamlClient:
        """
    ...
    def list_saml_clients(self, query_params: Dict[str, object] = None) -> List[str]:
        """
        List SAML clients.
        """
        if query_params is None:
    ...
    def reset_password(self, reset_password_body: ResetPasswordBody, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
        ...
        path = Template("/system/identity/v3/reset-password").substitute(path_params)
        url = self.base_client.build_url(path)
        data = reset_password_body.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, )
    ...
    def update_entitlements(self, entitlement_client_id: str, set_entitlement: List[SetEntitlement], query_params: Dict[str, object] = None) -> List[Entitlement]:
        """
        ...
        path = Template("/identity/v3/commerce/subscribed-apps/${entitlementClientId}/entitlements").substitute(path_params)
        url = self.base_client.build_url(path)
        data = [e.to_dict() for e in set_entitlement]
        response = self.base_client.put(url, json=data, params=query_params)
        return handle_response(response, Entitlement)

    def update_group(self, group: str, update_group_body: UpdateGroupBody, query_params: Dict[str, object] = None) -> Group:
        """
        ...
        path = Template("/identity/v3/groups/${group}").substitute(path_params)
        url = self.base_client.build_url(path)
        data = update_group_body.to_dict()
    ...
    def update_password(self, principal: str, update_password_body: UpdatePasswordBody, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
        ...
        path = Template("/system/identity/v3/principals/${principal}/password").substitute(path_params)
        url = self.base_client.build_url(path)
        data = update_password_body.to_dict()
        response = self.base_client.patch(url, json=data, params=query_params)
        return handle_response(response, )
    ...
    def update_role(self, role: str, update_role_body: UpdateRoleBody, query_params: Dict[str, object] = None) -> Role:
        """
        ...
        path = Template("/identity/v3/roles/${role}").substitute(path_params)
        url = self.base_client.build_url(path)
        data = update_role_body.to_dict()
        response = self.base_client.patch(url, json=data, params=query_params)
        return handle_response(response, Role)

    def update_saml_client(self, saml_client: str, update_saml_client_body: UpdateSamlClientBody, query_params: Dict[str, object] = None) -> SamlClient:
        """
        ...
        path = Template("/identity/v3/clients/saml/${samlClient}").substitute(path_params)
        url = self.base_client.build_url(path)
        data = update_saml_client_body.to_dict()
        response = self.base_client.put(url, json=data, params=query_params)
        return handle_response(response, SamlClient)

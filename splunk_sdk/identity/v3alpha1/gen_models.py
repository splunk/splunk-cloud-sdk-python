...
class AddInvisibleMemberBody(SSCModel):

    @staticmethod
    def _from_dict(model: dict) -> "AddInvisibleMemberBody":
        instance = AddInvisibleMemberBody.__new__(AddInvisibleMemberBody)
        instance._attrs = model
        return instance

    def __init__(self, name: "str", reason: "str", expires_in: "int" = None, **extra):
        ...
        if reason is not None:
            self._attrs["reason"] = reason
        if expires_in is not None:
            self._attrs["expires_in"] = expires_in
        for k, v in extra.items():
            self._attrs[k] = v

    @property
    def name(self) -> "str":
        """ Gets the name of this AddInvisibleMemberBody.
    ...
    @name.setter
    def name(self, name: "str"):
        """Sets the name of this AddInvisibleMemberBody.

        The name of the member to be added.

        :param name: The name of this AddInvisibleMemberBody.
        :type: str
        """
        if name is None:
            raise ValueError("Invalid value for `name`, must not be `None`")
    ...
    @property
    def reason(self) -> "str":
        """ Gets the reason of this AddInvisibleMemberBody.
    ...
    def reason(self, reason: "str"):
        """Sets the reason of this AddInvisibleMemberBody.

        The reason you are adding this member.

        :param reason: The reason of this AddInvisibleMemberBody.
        :type: str
        """
        if reason is None:
    ...
    def expires_in(self) -> "int":
        """ Gets the expires_in of this AddInvisibleMemberBody.
        The expiration time of the member in seconds.
        """
        return self._attrs.get("expires_in")

    @expires_in.setter
    def expires_in(self, expires_in: "int"):
        """Sets the expires_in of this AddInvisibleMemberBody.

        The expiration time of the member in seconds.

        :param expires_in: The expires_in of this AddInvisibleMemberBody.
        :type: int
        """
        self._attrs["expires_in"] = expires_in

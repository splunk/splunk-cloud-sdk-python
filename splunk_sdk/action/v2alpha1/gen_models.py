...
class AppMessageAction(Action):
    ...
    def __init__(self, name: "str", created_at: "datetime" = None, created_by: "str" = None, expiration_time_utc_epoch: "int" = None, groups: "List[str]" = None, icon_url: "str" = None, link: "str" = None, members: "List[str]" = None, message: "str" = None, title: "str" = None, updated_at: "datetime" = None, updated_by: "str" = None, **extra):
        """AppMessageAction"""
        ...
        if created_by is not None:
            self._attrs["createdBy"] = created_by
        if expiration_time_utc_epoch is not None:
            self._attrs["expirationTimeUTCEpoch"] = expiration_time_utc_epoch
    ...
    @property
    def expiration_time_utc_epoch(self) -> "int":
        """ Gets the expiration_time_utc_epoch of this AppMessageAction.
        Unix epoch datetime stamp in UTC indicating when the message should expire.
        """
        return self._attrs.get("expirationTimeUTCEpoch")

    @expiration_time_utc_epoch.setter
    def expiration_time_utc_epoch(self, expiration_time_utc_epoch: "int"):
        """Sets the expiration_time_utc_epoch of this AppMessageAction.

        Unix epoch datetime stamp in UTC indicating when the message should expire.

        :param expiration_time_utc_epoch: The expiration_time_utc_epoch of this AppMessageAction.
        :type: int
        """
        self._attrs["expirationTimeUTCEpoch"] = expiration_time_utc_epoch
    ...
    def groups(self) -> "List[str]":
        """ Gets the groups of this AppMessageAction.
    ...
    def groups(self, groups: "List[str]"):
        """Sets the groups of this AppMessageAction.

        An array of tenant groups, whose members should receive the message when it's triggered.

        :param groups: The groups of this AppMessageAction.
        :type: List[str]
        """
        self._attrs["groups"] = groups
    ...
    def members(self) -> "List[str]":
        """ Gets the members of this AppMessageAction.
    ...
    def members(self, members: "List[str]"):
        """Sets the members of this AppMessageAction.

        An array of tenant member names that should receive the message when it's triggered.

        :param members: The members of this AppMessageAction.
        :type: List[str]
        """
        self._attrs["members"] = members

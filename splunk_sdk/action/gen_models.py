...
class EmailAction(Action):
    ...
    def from_name(self) -> "str":
        ...
        Optional text providing a human-friendly name for the sender. Must be less than or equal to 81 characters.
        """
...
class TriggerEvent(SSCModel):
    ...
    def __init__(self, kind: "TriggerEventKind", action_metadata: "TriggerEventActionMetadata" = None, created_at: "str" = None, created_by: "str" = None, id: "str" = None, payload: "Dict[str, object]" = None, tenant: "str" = None, trigger_condition: "str" = None, trigger_name: "str" = None, ttl_seconds: "int" = 3600, **extra):
        """TriggerEvent"""

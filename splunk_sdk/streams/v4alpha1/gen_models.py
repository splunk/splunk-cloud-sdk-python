...
class AutopilotActivationDeactivationResponse(SSCModel):

    @staticmethod
    def _from_dict(model: dict) -> "AutopilotActivationDeactivationResponse":
        instance = AutopilotActivationDeactivationResponse.__new__(AutopilotActivationDeactivationResponse)
        instance._attrs = model
        return instance
    ...
    def message(self) -> "str":
        """ Gets the message of this AutopilotActivationDeactivationResponse.
        """
        return self._attrs.get("message")

    @message.setter
    def message(self, message: "str"):
        """Sets the message of this AutopilotActivationDeactivationResponse.


        :param message: The message of this AutopilotActivationDeactivationResponse.
        :type: str
        """
        self._attrs["message"] = message
...
class SavepointEnum(str, Enum):
    ...
    def from_value(value: str):
        if value == "required":
            return SavepointEnum.REQUIRED
        if value == "optional":
            return SavepointEnum.OPTIONAL
        if value == "none":
            return SavepointEnum.NONE
...
class DeactivatePipelineRequest(SSCModel):
    ...
    def __init__(self, savepoint: "str" = None, **extra):
        """DeactivatePipelineRequest"""

        self._attrs = dict()
        if savepoint is not None:
            self._attrs["savepoint"] = savepoint
        for k, v in extra.items():
            self._attrs[k] = v

    @property
    def savepoint(self) -> "SavepointEnum":
        """ Gets the savepoint of this DeactivatePipelineRequest.
        ...
        """
        return SavepointEnum.from_value(self._attrs.get("savepoint"))

    @savepoint.setter
    def savepoint(self, savepoint: "str"):
        """Sets the savepoint of this DeactivatePipelineRequest.

        Define whether to create a savepoint upon deactivation. Choosing 'none' means to skip creating a final savepoint; 'optional' means best effort (attempt to create savepoint but still deactivate the pipeline if it fails); 'required' means to only deactivate the pipeline if a savepoint can be saved. Defaults to required.

        :param savepoint: The savepoint of this DeactivatePipelineRequest.
        :type: str
        """
        if isinstance(savepoint, Enum):
            self._attrs["savepoint"] = savepoint.value
        else:
            self._attrs["savepoint"] = savepoint  # If you supply a string, we presume you know the service will take it.
...
class Pipeline_statusEnum(str, Enum):
    CREATED = "CREATED"
    ACTIVATED = "ACTIVATED"
    FAILED = "FAILED"
    ...
    def from_value(value: str):
        if value == "CREATED":
            return Pipeline_statusEnum.CREATED
        if value == "ACTIVATED":
            return Pipeline_statusEnum.ACTIVATED
        if value == "FAILED":
            return Pipeline_statusEnum.FAILED
        if value == "RESTARTING":
            return Pipeline_statusEnum.RESTARTING
        if value == "FINISHED":
            return Pipeline_statusEnum.FINISHED
        if value == "ACTIVATING":
            return Pipeline_statusEnum.ACTIVATING
        if value == "DEACTIVATING":
            return Pipeline_statusEnum.DEACTIVATING
        if value == "UPDATING":
            return Pipeline_statusEnum.UPDATING
        if value == "RECONCILING":
            return Pipeline_statusEnum.RECONCILING
        if value == "SCALING":
            return Pipeline_statusEnum.SCALING
        if value == "RUNNING":
            return Pipeline_statusEnum.RUNNING
        if value == "DEACTIVATED":
            return Pipeline_statusEnum.DEACTIVATED


class PipelineResponseV4(SSCModel):

    @staticmethod
    def _from_dict(model: dict) -> "PipelineResponseV4":
        instance = PipelineResponseV4.__new__(PipelineResponseV4)
        instance._attrs = model
        return instance

    def __init__(self, activated_date: "int" = None, activated_version: "int" = None, complexity: "float" = None, create_date: "int" = None, create_user_id: "str" = None, current_version: "int" = None, data: "Pipeline" = None, description: "str" = None, error_on_last_action: "UpdateError" = None, id: "str" = None, labels: "Dict[str, str]" = None, last_update_date: "int" = None, last_update_user_id: "str" = None, name: "str" = None, pipeline_status: "str" = None, tenant_id: "str" = None, validation_messages: "List[str]" = None, version: "int" = None, **extra):
        """PipelineResponseV4"""
        ...
        if description is not None:
            self._attrs["description"] = description
        if error_on_last_action is not None:
            self._attrs["errorOnLastAction"] = error_on_last_action.to_dict()
        if id is not None:
            self._attrs["id"] = id
        ...
        if pipeline_status is not None:
            self._attrs["pipelineStatus"] = pipeline_status
        if tenant_id is not None:
            self._attrs["tenantId"] = tenant_id
    ...
    def activated_date(self) -> "int":
        """ Gets the activated_date of this PipelineResponseV4.
        """
        return self._attrs.get("activatedDate")

    @activated_date.setter
    def activated_date(self, activated_date: "int"):
        """Sets the activated_date of this PipelineResponseV4.


        :param activated_date: The activated_date of this PipelineResponseV4.
        :type: int
        """
        self._attrs["activatedDate"] = activated_date
    ...
    def activated_version(self) -> "int":
        """ Gets the activated_version of this PipelineResponseV4.
        """
        return self._attrs.get("activatedVersion")

    @activated_version.setter
    def activated_version(self, activated_version: "int"):
        """Sets the activated_version of this PipelineResponseV4.


        :param activated_version: The activated_version of this PipelineResponseV4.
        :type: int
        """
        self._attrs["activatedVersion"] = activated_version
    ...
    def complexity(self) -> "float":
        """ Gets the complexity of this PipelineResponseV4.
        """
        return self._attrs.get("complexity")

    @complexity.setter
    def complexity(self, complexity: "float"):
        """Sets the complexity of this PipelineResponseV4.


        :param complexity: The complexity of this PipelineResponseV4.
        :type: float
        """
        self._attrs["complexity"] = complexity
    ...
    @property
    def create_date(self) -> "int":
        """ Gets the create_date of this PipelineResponseV4.
        """
        return self._attrs.get("createDate")

    @create_date.setter
    def create_date(self, create_date: "int"):
        """Sets the create_date of this PipelineResponseV4.


        :param create_date: The create_date of this PipelineResponseV4.
        :type: int
        """
        self._attrs["createDate"] = create_date
    ...
    @property
    def create_user_id(self) -> "str":
        """ Gets the create_user_id of this PipelineResponseV4.
        """
        return self._attrs.get("createUserId")

    @create_user_id.setter
    def create_user_id(self, create_user_id: "str"):
        """Sets the create_user_id of this PipelineResponseV4.


        :param create_user_id: The create_user_id of this PipelineResponseV4.
        :type: str
        """
        self._attrs["createUserId"] = create_user_id
    ...
    def current_version(self) -> "int":
        """ Gets the current_version of this PipelineResponseV4.
        """
        return self._attrs.get("currentVersion")

    @current_version.setter
    def current_version(self, current_version: "int"):
        """Sets the current_version of this PipelineResponseV4.


        :param current_version: The current_version of this PipelineResponseV4.
        :type: int
        """
        self._attrs["currentVersion"] = current_version
    ...
    def data(self) -> "Pipeline":
        """ Gets the data of this PipelineResponseV4.
        """
        return Pipeline._from_dict(self._attrs["data"])

    @data.setter
    def data(self, data: "Pipeline"):
        """Sets the data of this PipelineResponseV4.


        :param data: The data of this PipelineResponseV4.
        :type: Pipeline
        """
        self._attrs["data"] = data.to_dict()
    ...
    @property
    def description(self) -> "str":
        """ Gets the description of this PipelineResponseV4.
        """
        return self._attrs.get("description")

    @description.setter
    def description(self, description: "str"):
        """Sets the description of this PipelineResponseV4.


        :param description: The description of this PipelineResponseV4.
        :type: str
        """
        self._attrs["description"] = description

    @property
    def error_on_last_action(self) -> "UpdateError":
        """ Gets the error_on_last_action of this PipelineResponseV4.
        """
        return UpdateError._from_dict(self._attrs["errorOnLastAction"])

    @error_on_last_action.setter
    def error_on_last_action(self, error_on_last_action: "UpdateError"):
        """Sets the error_on_last_action of this PipelineResponseV4.


        :param error_on_last_action: The error_on_last_action of this PipelineResponseV4.
        :type: UpdateError
        """
        self._attrs["errorOnLastAction"] = error_on_last_action.to_dict()
    ...
    @property
    def id(self) -> "str":
        """ Gets the id of this PipelineResponseV4.
        """
        return self._attrs.get("id")

    @id.setter
    def id(self, id: "str"):
        """Sets the id of this PipelineResponseV4.


        :param id: The id of this PipelineResponseV4.
        :type: str
        """
        self._attrs["id"] = id
    ...
    def labels(self) -> "Dict[str, str]":
        """ Gets the labels of this PipelineResponseV4.
        """
        return self._attrs.get("labels")

    @labels.setter
    def labels(self, labels: "Dict[str, str]"):
        """Sets the labels of this PipelineResponseV4.


        :param labels: The labels of this PipelineResponseV4.
        :type: Dict[str, str]
        """
        self._attrs["labels"] = labels
    ...
    @property
    def last_update_date(self) -> "int":
        """ Gets the last_update_date of this PipelineResponseV4.
        """
        return self._attrs.get("lastUpdateDate")

    @last_update_date.setter
    def last_update_date(self, last_update_date: "int"):
        """Sets the last_update_date of this PipelineResponseV4.


        :param last_update_date: The last_update_date of this PipelineResponseV4.
        :type: int
        """
        self._attrs["lastUpdateDate"] = last_update_date
    ...
    @property
    def last_update_user_id(self) -> "str":
        """ Gets the last_update_user_id of this PipelineResponseV4.
        """
        return self._attrs.get("lastUpdateUserId")

    @last_update_user_id.setter
    def last_update_user_id(self, last_update_user_id: "str"):
        """Sets the last_update_user_id of this PipelineResponseV4.


        :param last_update_user_id: The last_update_user_id of this PipelineResponseV4.
        :type: str
        """
        self._attrs["lastUpdateUserId"] = last_update_user_id
    ...
    @property
    def name(self) -> "str":
        """ Gets the name of this PipelineResponseV4.
        """
        return self._attrs.get("name")

    @name.setter
    def name(self, name: "str"):
        """Sets the name of this PipelineResponseV4.


        :param name: The name of this PipelineResponseV4.
        :type: str
        """
        self._attrs["name"] = name

    @property
    def pipeline_status(self) -> "Pipeline_statusEnum":
        """ Gets the pipeline_status of this PipelineResponseV4.
        """
        return Pipeline_statusEnum.from_value(self._attrs.get("pipelineStatus"))

    @pipeline_status.setter
    def pipeline_status(self, pipeline_status: "str"):
        """Sets the pipeline_status of this PipelineResponseV4.


        :param pipeline_status: The pipeline_status of this PipelineResponseV4.
        :type: str
        """
        if isinstance(pipeline_status, Enum):
            self._attrs["pipelineStatus"] = pipeline_status.value
        else:
            self._attrs["pipelineStatus"] = pipeline_status  # If you supply a string, we presume you know the service will take it.

    @property
    def tenant_id(self) -> "str":
        """ Gets the tenant_id of this PipelineResponseV4.
        """
        return self._attrs.get("tenantId")

    @tenant_id.setter
    def tenant_id(self, tenant_id: "str"):
        """Sets the tenant_id of this PipelineResponseV4.


        :param tenant_id: The tenant_id of this PipelineResponseV4.
        :type: str
        """
        self._attrs["tenantId"] = tenant_id
    ...
    def validation_messages(self) -> "List[str]":
        """ Gets the validation_messages of this PipelineResponseV4.
        """
    ...
    def validation_messages(self, validation_messages: "List[str]"):
        """Sets the validation_messages of this PipelineResponseV4.


        :param validation_messages: The validation_messages of this PipelineResponseV4.
        :type: List[str]
        """
        self._attrs["validationMessages"] = validation_messages
    ...
    @property
    def version(self) -> "int":
        """ Gets the version of this PipelineResponseV4.
        """
        return self._attrs.get("version")

    @version.setter
    def version(self, version: "int"):
        """Sets the version of this PipelineResponseV4.


        :param version: The version of this PipelineResponseV4.
        :type: int
        """
        self._attrs["version"] = version
...
class UpdateError(SSCModel):

    @staticmethod
    def _from_dict(model: dict) -> "UpdateError":
        instance = UpdateError.__new__(UpdateError)
        instance._attrs = model
        return instance

    def __init__(self, description: "str" = None, timestamp: "int" = None, type: "str" = None, **extra):
        """UpdateError"""
    ...
    @property
    def description(self) -> "str":
        """ Gets the description of this UpdateError.
        """
        return self._attrs.get("description")

    @description.setter
    def description(self, description: "str"):
        """Sets the description of this UpdateError.


        :param description: The description of this UpdateError.
        :type: str
        """
        self._attrs["description"] = description
    ...
    def timestamp(self) -> "int":
        """ Gets the timestamp of this UpdateError.
        """
        return self._attrs.get("timestamp")

    @timestamp.setter
    def timestamp(self, timestamp: "int"):
        """Sets the timestamp of this UpdateError.


        :param timestamp: The timestamp of this UpdateError.
        :type: int
        """
        self._attrs["timestamp"] = timestamp
    ...
    @property
    def type(self) -> "str":
        """ Gets the type of this UpdateError.
        """
        return self._attrs.get("type")

    @type.setter
    def type(self, type: "str"):
        """Sets the type of this UpdateError.


        :param type: The type of this UpdateError.
        :type: str
        """
        self._attrs["type"] = type
...
class PaginatedResponseOfPipelineResponseV4(SSCModel):

    @staticmethod
    def _from_dict(model: dict) -> "PaginatedResponseOfPipelineResponseV4":
        instance = PaginatedResponseOfPipelineResponseV4.__new__(PaginatedResponseOfPipelineResponseV4)
        instance._attrs = model
        return instance

    def __init__(self, items: "List[PipelineResponseV4]" = None, total: "int" = None, **extra):
    ...
    @property
    def items(self) -> "List[PipelineResponseV4]":
        """ Gets the items of this PaginatedResponseOfPipelineResponseV4.
        """
        return [PipelineResponseV4._from_dict(i) for i in self._attrs.get("items")]

    @items.setter
    def items(self, items: "List[PipelineResponseV4]"):
        """Sets the items of this PaginatedResponseOfPipelineResponseV4.


        :param items: The items of this PaginatedResponseOfPipelineResponseV4.
        :type: List[PipelineResponseV4]
        """
        self._attrs["items"] = items

    @property
    def total(self) -> "int":
        """ Gets the total of this PaginatedResponseOfPipelineResponseV4.
        """
        return self._attrs.get("total")

    @total.setter
    def total(self, total: "int"):
        """Sets the total of this PaginatedResponseOfPipelineResponseV4.


        :param total: The total of this PaginatedResponseOfPipelineResponseV4.
        :type: int
        """
        self._attrs["total"] = total

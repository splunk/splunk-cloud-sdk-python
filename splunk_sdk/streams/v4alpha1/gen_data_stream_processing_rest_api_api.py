...
from splunk_sdk.streams.v4alpha1.gen_models import AutopilotActivationDeactivationResponse
from splunk_sdk.streams.v4alpha1.gen_models import ConnectionPatchRequest
from splunk_sdk.streams.v4alpha1.gen_models import ConnectionPutRequest
from splunk_sdk.streams.v4alpha1.gen_models import ConnectionRequest
from splunk_sdk.streams.v4alpha1.gen_models import ConnectionSaveResponse
from splunk_sdk.streams.v4alpha1.gen_models import DeactivatePipelineRequest
from splunk_sdk.streams.v4alpha1.gen_models import DecompileRequest
from splunk_sdk.streams.v4alpha1.gen_models import DecompileResponse
from splunk_sdk.streams.v4alpha1.gen_models import ErrorResponse
from splunk_sdk.streams.v4alpha1.gen_models import FilesMetaDataResponse
from splunk_sdk.streams.v4alpha1.gen_models import GetInputSchemaRequest
from splunk_sdk.streams.v4alpha1.gen_models import GetOutputSchemaRequest
from splunk_sdk.streams.v4alpha1.gen_models import LookupTableResponse
from splunk_sdk.streams.v4alpha1.gen_models import MetricsResponse
from splunk_sdk.streams.v4alpha1.gen_models import PaginatedResponseOfConnectionResponse
from splunk_sdk.streams.v4alpha1.gen_models import PaginatedResponseOfConnectorResponse
from splunk_sdk.streams.v4alpha1.gen_models import PaginatedResponseOfPipelineResponseV4
from splunk_sdk.streams.v4alpha1.gen_models import PaginatedResponseOfTemplateResponse
from splunk_sdk.streams.v4alpha1.gen_models import Pipeline
from splunk_sdk.streams.v4alpha1.gen_models import PipelinePatchRequest
from splunk_sdk.streams.v4alpha1.gen_models import PipelineRequest
from splunk_sdk.streams.v4alpha1.gen_models import PipelineResponseV4
from splunk_sdk.streams.v4alpha1.gen_models import PreviewData
from splunk_sdk.streams.v4alpha1.gen_models import PreviewSessionStartRequest
from splunk_sdk.streams.v4alpha1.gen_models import PreviewStartResponse
from splunk_sdk.streams.v4alpha1.gen_models import PreviewState
from splunk_sdk.streams.v4alpha1.gen_models import RegistryModel
from splunk_sdk.streams.v4alpha1.gen_models import SplCompileRequest
from splunk_sdk.streams.v4alpha1.gen_models import TemplatePatchRequest
from splunk_sdk.streams.v4alpha1.gen_models import TemplatePutRequest
from splunk_sdk.streams.v4alpha1.gen_models import TemplateRequest
from splunk_sdk.streams.v4alpha1.gen_models import TemplateResponse
from splunk_sdk.streams.v4alpha1.gen_models import UplType
from splunk_sdk.streams.v4alpha1.gen_models import UploadFileResponse
from splunk_sdk.streams.v4alpha1.gen_models import ValidateConnectionRequest
from splunk_sdk.streams.v4alpha1.gen_models import ValidateRequest
from splunk_sdk.streams.v4alpha1.gen_models import ValidateResponse
...
class DataStreamProcessingRESTAPI(BaseService):
    ...
    def activate_pipeline(self, id: str, activate_pipeline_request: ActivatePipelineRequest, query_params: Dict[str, object] = None) -> AutopilotActivationDeactivationResponse:
        """
        ...
        path = Template("/streams/v4alpha1/pipelines/${id}/activate").substitute(path_params)
        url = self.base_client.build_url(path)
        data = activate_pipeline_request.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, AutopilotActivationDeactivationResponse)
    ...
    def compile(self, spl_compile_request: SplCompileRequest, query_params: Dict[str, object] = None) -> Pipeline:
        ...
        path = Template("/streams/v4alpha1/pipelines/compile").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def create_connection(self, connection_request: ConnectionRequest, skip_validation: bool = None, query_params: Dict[str, object] = None) -> ConnectionSaveResponse:
        ...
        path = Template("/streams/v4alpha1/connections").substitute(path_params)
        url = self.base_client.build_url(path)
        data = connection_request.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, ConnectionSaveResponse)

    def create_pipeline(self, pipeline_request: PipelineRequest, query_params: Dict[str, object] = None) -> PipelineResponseV4:
        """
        Creates a pipeline.
        """
        if query_params is None:
        ...
        path = Template("/streams/v4alpha1/pipelines").substitute(path_params)
        url = self.base_client.build_url(path)
        data = pipeline_request.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, PipelineResponseV4)
    ...
    def create_template(self, template_request: TemplateRequest, query_params: Dict[str, object] = None) -> TemplateResponse:
        ...
        path = Template("/streams/v4alpha1/templates").substitute(path_params)
        url = self.base_client.build_url(path)
        data = template_request.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, TemplateResponse)

    def deactivate_pipeline(self, id: str, deactivate_pipeline_request: DeactivatePipelineRequest, query_params: Dict[str, object] = None) -> AutopilotActivationDeactivationResponse:
        """
        ...
        path = Template("/streams/v4alpha1/pipelines/${id}/deactivate").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def decompile(self, decompile_request: DecompileRequest, query_params: Dict[str, object] = None) -> DecompileResponse:
        ...
        path = Template("/streams/v4alpha1/pipelines/decompile").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def delete_connection(self, connection_id: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        ...
        path = Template("/streams/v4alpha1/connections/${connectionId}").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def delete_lookup_file(self, file_id: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        ...
        path = Template("/streams/v4alpha1/lookups/files/${fileId}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.delete(url, params=query_params)
        return handle_response(response, )
    ...
    def delete_pipeline(self, id: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        ...
        path = Template("/streams/v4alpha1/pipelines/${id}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.delete(url, params=query_params)
        return handle_response(response, )
    ...
    def delete_template(self, template_id: str, query_params: Dict[str, object] = None) -> SSCVoidModel:
        ...
        path = Template("/streams/v4alpha1/templates/${templateId}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.delete(url, params=query_params)
        return handle_response(response, )
    ...
    def get_input_schema(self, get_input_schema_request: GetInputSchemaRequest, query_params: Dict[str, object] = None) -> UplType:
        ...
        path = Template("/streams/v4alpha1/pipelines/input-schema").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def get_lookup_files_metadata(self, query_params: Dict[str, object] = None) -> FilesMetaDataResponse:
        ...
        path = Template("/streams/v4alpha1/lookups/files").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def get_lookup_table(self, connection_id: str, offset: int, size: int, query_params: Dict[str, object] = None) -> LookupTableResponse:
        ...
        path = Template("/streams/v4alpha1/lookups/${connectionId}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def get_output_schema(self, get_output_schema_request: GetOutputSchemaRequest, query_params: Dict[str, object] = None) -> Dict[str, UplType]:
        ...
        path = Template("/streams/v4alpha1/pipelines/output-schema").substitute(path_params)
        url = self.base_client.build_url(path)
        data = get_output_schema_request.to_dict()
        response = self.base_client.post(url, json=data, params=query_params)
        return handle_response(response, UplType)

    def get_pipeline(self, id: str, version: str = None, query_params: Dict[str, object] = None) -> PipelineResponseV4:
        """
    ...
    def get_pipeline_latest_metrics(self, id: str, query_params: Dict[str, object] = None) -> MetricsResponse:
        ...
        path = Template("/streams/v4alpha1/pipelines/${id}/metrics/latest").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def get_preview_data(self, preview_session_id: str, query_params: Dict[str, object] = None) -> PreviewData:
        ...
        path = Template("/streams/v4alpha1/preview-data/${previewSessionId}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def get_preview_session(self, preview_session_id: str, query_params: Dict[str, object] = None) -> PreviewState:
        ...
        path = Template("/streams/v4alpha1/preview-session/${previewSessionId}").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def get_preview_session_latest_metrics(self, preview_session_id: str, query_params: Dict[str, object] = None) -> MetricsResponse:
        ...
        path = Template("/streams/v4alpha1/preview-session/${previewSessionId}/metrics/latest").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
        return handle_response(response, MetricsResponse)
    ...
    def get_registry(self, local: bool = None, query_params: Dict[str, object] = None) -> RegistryModel:
        ...
        path = Template("/streams/v4alpha1/pipelines/registry").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
    ...
    def list_connectors(self, query_params: Dict[str, object] = None) -> PaginatedResponseOfConnectorResponse:
        ...
        path = Template("/streams/v4alpha1/connectors").substitute(path_params)
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
        return handle_response(response, PaginatedResponseOfConnectorResponse)

    def list_pipelines(self, activated: bool = None, create_user_id: str = None, include_data: bool = None, include_status: bool = None, name: str = None, offset: int = None, page_size: int = None, sort_dir: str = None, sort_field: str = None, query_params: Dict[str, object] = None) -> PaginatedResponseOfPipelineResponseV4:
        """
        ...
        url = self.base_client.build_url(path)
        response = self.base_client.get(url, params=query_params)
        return handle_response(response, PaginatedResponseOfPipelineResponseV4)
    ...
    def patch_pipeline(self, id: str, pipeline_patch_request: PipelinePatchRequest, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
    ...
    def start_preview(self, preview_session_start_request: PreviewSessionStartRequest, query_params: Dict[str, object] = None) -> PreviewStartResponse:
        ...
        path = Template("/streams/v4alpha1/preview-session").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def update_pipeline(self, id: str, pipeline_request: PipelineRequest, query_params: Dict[str, object] = None) -> SSCVoidModel:
        """
    ...
    def validate_connection(self, validate_connection_request: ValidateConnectionRequest, query_params: Dict[str, object] = None) -> SSCVoidModel:
        ...
        path = Template("/streams/v4alpha1/connections/validate").substitute(path_params)
        url = self.base_client.build_url(path)
    ...
    def validate_pipeline(self, validate_request: ValidateRequest, query_params: Dict[str, object] = None) -> ValidateResponse:
        ...
        path = Template("/streams/v4alpha1/pipelines/validate").substitute(path_params)
        url = self.base_client.build_url(path)

...
class LookupTableResponse(SSCModel):
    ...
    def __init__(self, data: "List[JsonNode]" = None, types: "Dict[str, str]" = None, **extra):
        """LookupTableResponse"""
    ...
    @property
    def data(self) -> "List[JsonNode]":
        """ Gets the data of this LookupTableResponse.
        """
        return [JsonNode._from_dict(i) for i in self._attrs.get("data")]

    @data.setter
    def data(self, data: "List[JsonNode]"):

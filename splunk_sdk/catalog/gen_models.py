...
class Action(SSCModel):
    ...
    def _from_dict(model: dict) -> "Action":
        kind = model['kind']
        handler = Action.from_dict_handlers[kind]
...
class ActionPOST(SSCModel):
    ...
    def _from_dict(model: dict) -> "ActionPOST":
        kind = model['kind']
        handler = ActionPOST.from_dict_handlers[kind]
        if handler is not None:
            return handler(model)
        else:
            raise ValueError("Unknown value for kind")
...
class Annotation(SSCModel):
    ...
    def __init__(self, created: "datetime", createdby: "str", modified: "datetime", modifiedby: "str", owner: "str", annotationtypeid: "str" = None, datasetid: "str" = None, fieldid: "str" = None, id: "str" = None, relationshipid: "str" = None, **extra):
        """Annotation"""
...
class AnnotationPOST(SSCModel):
    ...
    def __init__(self, annotationtypeid: "str" = None, annotationtyperesourcename: "str" = None, datasetid: "str" = None, fieldid: "str" = None, id: "str" = None, relationshipid: "str" = None, **extra):
        """AnnotationPOST"""
...
class Dataset(SSCModel):
    ...
    def _from_dict(model: dict) -> "Dataset":
        kind = model['kind']
        handler = Dataset.from_dict_handlers[kind]
        if handler is not None:
            return handler(model)
        else:
            raise ValueError("Unknown value for kind")
...
class DatasetImportedBy(SSCModel):
    ...
    def __init__(self, module: "str", name: "str", **extra):
        """DatasetImportedBy"""
...
class DatasetPOST(SSCModel):
    ...
    def _from_dict(model: dict) -> "DatasetPOST":
        kind = model['kind']
        handler = DatasetPOST.from_dict_handlers[kind]
        if handler is not None:
            return handler(model)
        else:
            raise ValueError("Unknown value for kind")

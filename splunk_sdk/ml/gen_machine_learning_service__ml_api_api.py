...
class MachineLearningServiceMLAPI(BaseService):
    ...
    def create_workflow_build(self, id: str, workflow_build: WorkflowBuild) -> WorkflowBuild:
        """
    ...
    def create_workflow_deployment(self, id: str, build_id: str, workflow_deployment: WorkflowDeployment) -> WorkflowDeployment:
        """
    ...
    def create_workflow_inference(self, id: str, build_id: str, deployment_id: str, workflow_inference: WorkflowInference) -> WorkflowInference:
        """
    ...
    def create_workflow_run(self, id: str, build_id: str, workflow_run: WorkflowRun) -> WorkflowRun:
        """
    ...
    def delete_workflow(self, id: str) -> SSCVoidModel:
        """
    ...
    def delete_workflow_build(self, id: str, build_id: str) -> SSCVoidModel:
        """
    ...
    def delete_workflow_deployment(self, id: str, build_id: str, deployment_id: str) -> SSCVoidModel:
        """
    ...
    def delete_workflow_run(self, id: str, build_id: str, run_id: str) -> SSCVoidModel:
        """
    ...
    def get_workflow_build(self, id: str, build_id: str) -> WorkflowBuild:
        """
    ...
    def get_workflow_build_error(self, id: str, build_id: str) -> WorkflowBuildError:
        """
    ...
    def get_workflow_build_log(self, id: str, build_id: str) -> WorkflowBuildLog:
        """
    ...
    def get_workflow_deployment(self, id: str, build_id: str, deployment_id: str) -> WorkflowDeployment:
        """
    ...
    def get_workflow_deployment_error(self, id: str, build_id: str, deployment_id: str) -> WorkflowDeploymentError:
        """
    ...
    def get_workflow_deployment_log(self, id: str, build_id: str, deployment_id: str) -> WorkflowDeploymentLog:
        """
    ...
    def get_workflow_run(self, id: str, build_id: str, run_id: str) -> WorkflowRun:
        """
    ...
    def get_workflow_run_error(self, id: str, build_id: str, run_id: str) -> WorkflowRunError:
        """
    ...
    def get_workflow_run_log(self, id: str, build_id: str, run_id: str) -> WorkflowRunLog:
        """
    ...
    def list_workflow_builds(self, id: str) -> List[WorkflowBuild]:
        """
    ...
    def list_workflow_deployments(self, id: str, build_id: str) -> List[WorkflowDeployment]:
        """
    ...
    def list_workflow_runs(self, id: str, build_id: str) -> List[WorkflowRun]:
        """
